...
namespace TestStuff
{
	public partial class frmTester : Form
	{
		...
		public frmTester()
		{
            ...
            TreeNode tn1;
<<<<<<< .mine
			// H:\z-studio\_ZStudio\ZStudio
			string baseDir = @"H:\z-studio\_ZStudio\ZStudio\";
//			string baseDir = @"C:\src\";
			string testDir = baseDir + @"data\NordellEx2IP4\testCases";
            foreach (string dir1 in Directory.EnumerateDirectories(testDir))
=======
