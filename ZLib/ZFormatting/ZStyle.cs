...
namespace ZLib
{
	public class ZStyle : ZObject<ZStyle>
	{
		...
		//}
		public ZStyle(ZObject<ZStyle> obj)
			: base(obj)
		{
		}
	...
	public class ZStyles : ZObjects<ZStyles, ZStyle>
	{
		public ZStyles(JArray jArray) : base(jArray) { }
		public ZStyles(ZObject<ZStyle> zObject) : base(zObject) { }
		public ZStyles() { }
	}
